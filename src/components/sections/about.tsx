...
export function AboutSection() {
  return (
    <AnimatedSection id="about" className="bg-[#F4F2EC] py-24 dark:bg-[#0E3746]">
      ...
      <div className="grid overflow-hidden rounded-[2rem] border border-black/10 lg:grid-cols-2 dark:border-white/10">
        ...
        <article className="bg-[#EAE8DC] p-8 text-[#0E3746] sm:p-12">
          <h3 className="text-lg font-semibold text-[#0E3746]">Mission</h3>
